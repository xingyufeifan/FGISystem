...
public class ImageCompress {
    ...
    public Bitmap compressFromUri(Context context,
        ...
        //获取实际宽高度
        int actualWidth = bm.getWidth();
        int actualHeight = bm.getHeight();
        System.out.println("图片实际宽高度："+actualWidth+"---"+actualHeight);
        ...
        System.out.println("图片压缩后的宽高度："+bitmap.getWidth()+"---"+bitmap.getHeight());
        return bitmap;
    }
